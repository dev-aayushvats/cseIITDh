  ...
  <div className="bg-white rounded-lg shadow-sm p-6">
    <div className="space-y-8">
      ...
      <Section id="bsms" title="BS-MS Dual Degree Admission">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="space-y-6">
            {bsms_dual_degree_admission.program_overview && (
              <div>
                <h3 className="text-xl font-semibold mb-3">{bsms_dual_degree_admission.program_overview.heading}</h3>
                <p className="text-gray-700 mb-3">
                  {bsms_dual_degree_admission.program_overview.description}
                </p>
              </div>
            )}
            
            {bsms_dual_degree_admission.admission_process && (
              <div>
                <h3 className="text-xl font-semibold mb-3">{bsms_dual_degree_admission.admission_process.heading}</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                  {bsms_dual_degree_admission.admission_process.steps.map((step, index) => (
                    <li key={index}>{step}</li>
                  ))}
                </ol>
              </div>
            ...
            {bsms_dual_degree_admission.program_structure && (
              <div>
                <h3 className="text-xl font-semibold mb-3">{bsms_dual_degree_admission.program_structure.heading}</h3>
                <p className="text-gray-700 mb-3">
                  {bsms_dual_degree_admission.program_structure.description}
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  {bsms_dual_degree_admission.program_structure.components.map((component, index) => (
            ...
            {bsms_dual_degree_admission.program_benefits && (
              <div className="bg-indigo-50 p-4 rounded-md">
                <h3 className="text-lg font-semibold mb-2">{bsms_dual_degree_admission.program_benefits.heading}</h3>
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                  {bsms_dual_degree_admission.program_benefits.benefits.map((benefit, index) => (
      ...
      <Section id="international" title="International Student Admissions">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="space-y-6">
            {international_student_admissions.admission_options && (
              <div>
                <h3 className="text-xl font-semibold mb-3">{international_student_admissions.admission_options.heading}</h3>
                <p className="text-gray-700 mb-3">
                  {international_student_admissions.admission_options.description}
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  {international_student_admissions.admission_options.pathways.map((pathway, index) => (
            ...
            {international_student_admissions.eligibility_requirements && (
              <div>
                <h3 className="text-xl font-semibold mb-3">{international_student_admissions.eligibility_requirements.heading}</h3>
                <p className="text-gray-700 mb-3">
                  General requirements for international applicants:
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  {international_student_admissions.eligibility_requirements.requirements.map((requirement, index) => (
            ...
            {international_student_admissions.application_process && (
              <div>
                <h3 className="text-xl font-semibold mb-3">{international_student_admissions.application_process.heading}</h3>
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                  {international_student_admissions.application_process.steps.map((step, index) => (
                    <li key={index}>{step}</li>
                  ))}
                </ol>
                  ...
                  <div className="flex">
                    <div className="ml-3">
                      <p className="text-sm text-yellow-700">
                        {international_student_admissions.application_process.note}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {international_student_admissions.international_admissions_guide && (
              <div className="text-center">
                <a href={international_student_admissions.international_admissions_guide.match(/\((.*?)\)/)[1]} className="inline-block bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition duration-300">
                  {international_student_admissions.international_admissions_guide.match(/\[(.*?)\]/)[1]}
                </a>
              </div>
            )}
          </div>
