...
const Home = () => {
    ...
    const news = [
        {
            title: "IIT Dharwad CSE launches new M.Tech. program",
            date: "June 2024",
            description: "The department has started a new M.Tech. program in Computer Science and Engineering from the academic year 2024-25."
        },
        {
        ...
        {
            title: "Student team wins Smart India Hackathon",
            date: "April 2024",
            description: "A team of CSE undergraduates won the national Smart India Hackathon 2024."
        }
    ];
